...
/*
export class MidSound extends Component {
  playTestInstrument() {
		this.midiSounds.playChordNow(3, [60], 2.5);
    //console.log(this.midiSounds.player.loader.instrumentKeys())
    console.log(this.midiSounds.player.loader.instrumentInfo(0).title)
	}
